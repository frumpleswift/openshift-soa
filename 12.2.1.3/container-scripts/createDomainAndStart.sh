...
#once the application server has started we want to pack a managed server template to use to add managed servers to the environment
/u01/oracle/oracle_common/common/bin/pack.sh -domain $DOMAIN_HOME -template /u01/oracle/user_templates/managedServerTemplate.jar -template_name ManagedServerTemplate -managed true
cd /u01/oracle/user_templates/
